        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (selectedCount > 0) {
                    ...
                    intent.putExtra("myandroidtutorial.macdidi.net.myandroidtutorial.Item", item);
    ...
    public void clickMenuItem(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case R.id.add_item:
                ...
                Intent intent = new Intent("myandroidtutorial.macdidi.net.myandroidtutorial.ADD_ITEM");
